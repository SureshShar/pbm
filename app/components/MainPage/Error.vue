<template>
  <section class="relative z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
    <div class="container">
      <div class="flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto max-w-[530px] text-center">
            ...
            <h3
              class="mb-4 text-3xl font-bold text-bgblack dark:text-bglight sm:text-4xl"
            >
              Sorry, the page can’t be found
            </h3>
            <p
              class="mb-10 text-base font-medium leading-relaxed text-black-L4 sm:text-lg sm:leading-relaxed"
            >
            ...
            <NuxtLink
              href="/"
              class="px-8 py-3 text-base font-bold text-bglight duration-300 rounded-md bg-primary shadow-signUp hover:bg-bglight hover:text-primary md:px-9 lg:px-8 xl:px-9"
            >
              Back to Homepage
            </NuxtLink>
          </div>
